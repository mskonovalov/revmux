---
description: all eight lenses across four cursor-agent models, with no claude or codex
model: cursor-agent/composer-2.5:high
agents:
  - {name: bugs+impl,    lenses: [bugs, impl],            model: cursor-agent/grok-4.6:high, color: cyan}
  - {name: arch+quality, lenses: [architecture, quality], model: cursor-agent/grok-4.5:high, color: magenta}
  - {name: docs+tests,   lenses: [docs, tests, comments], color: green}
  - {name: adversarial,  lenses: [adversarial],           model: cursor-agent/gpt-5.6-sol:high, color: yellow}
---
